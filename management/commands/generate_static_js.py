...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        outfile = open(os.path.join(path,'dj_jsurls.js'),'w')

        template = get_template('dj_jsurls/dj_jsurl_list.html')
        print template
        ...
        self.stdout.write('Successfully wrote static dj_jsurls.js file to "%s"\n' % os.path.join(path,'dj_jsurls.js'))
